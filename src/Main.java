...
public class Main {
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            Coffee coffeeOrder; // Инициализируем только здесь
            Syrup syrup; // Инициализируем только здесь
            Milk milk; // Инициализируем только здесь
            String coffeeType; // Инициализируем только здесь
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    Class<? extends Coffee> customCoffeeClass;
